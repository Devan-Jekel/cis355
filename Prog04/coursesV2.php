...
function printListing($apiCall) {
    ...
    if($_GET['days']){
        ...
        foreach ($obj->courses as $course) {
            ...
            if((strcmp(substr($course->meetingTimes[0]->days,0,1), $dayModifier)!=0 Xor strcmp(substr($course->meetingTimes[0]->days,1,1), $dayModifier)!=0)
               || (strcmp(substr($course->meetingTimes[1]->days,0,1), $dayModifier)!=0 Xor strcmp(substr($course->meetingTimes[1]->days,1,1), $dayModifier)!=0)){
