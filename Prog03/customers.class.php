...
class Customers {
  ...
  function list_records() {
        ...
        echo "
            ...
            <body>
            <p>Link to Prog03 GitHub code: <a href='https://github.com/Devan-Jekel/cis355/tree/master/Prog03'>https://github.com/Devan-Jekel/cis355/tree/master/Prog03</a></p>
            <p>To see files that were uploaded in a simple manner as per Prog03 part 1 specs, follow this link <a href='http://localhost/cis355/Prog03/uploads/'>http://localhost/cis355/Prog03/uploads/</a></p>
            <a href='http://localhost/cis355/Prog03/upload01.html' class='btn btn-success'>Simple File Upload</a> <br><br>
            <p>To see a List of files stored to MySQL database as BLOB as per Prog03 part 2 specs, follow this link <a href='http://localhost/cis355/Prog03/viewBlob.php'>http://localhost/cis355/Prog03/viewBlob.php</a></p>
            <a href='http://localhost/cis355/Prog03/upload03.html' class='btn btn-success'>BLOB File Upload</a> <br><br>
            <p>To see a List of files stored to MySQL database as file paths as per Prog03 part 3 specs, follow this link <a href='http://localhost/cis355/Prog03/viewPaths.php'>http://localhost/cis355/Prog03/viewPaths.php</a></p>
            <a href='http://localhost/cis355/Prog03/upload02.html' class='btn btn-success'>PATH File Upload</a> <br><br>
                <div class='container'>
                    <p class='row'>
                        <h3>$this->title" . "s" . "</h3>
                    </p>
